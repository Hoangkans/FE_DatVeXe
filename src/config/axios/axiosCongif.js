...
api.interceptors.response.use(
    ...
    async (err) => {
        ...
        if (err.response && (err.response.status === 401 || err.response.status === 403) && originalRequest && !originalRequest._retry) {
            ...
            try {
                ...
                console.error("Session expired completely. Logging out...", refreshError);
