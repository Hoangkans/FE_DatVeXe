      ...
      return (
        <div className="gallery-container" style={{ display: "flex", gap: 20 }}>
          ...
          >
            ...
            <div
              className="price-tag"
              style={{ color: "#ff5e1f", fontSize: "1.2rem", fontWeight: "bold" }}
            >
      ...
      <div className="trip__content">
        ...
        <div className="note-row">
          <div className="note muted small">
            *Thuộc chuyến {depart} {fromStation} đến {toStation}
          </div>
        </div>
      </div>
        ...
        <div className="trip__details">
          <div className="tabs">
            ...
            <button
              ...
              onClick={() => onTabChange("cancel")}
            >
              Phí hủy
            </button>
            <button
              className={`tabs__btn ${activeTab === "review" ? "is-active" : ""}`}
